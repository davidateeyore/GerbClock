...
// use newer library for RTC.. dt 10FEB2020
// test DST setup again.. dt 04OCT2020
...
void setup() { 
 ...
 // bool config=false;
  ...
  // get the date and time the compiler was run; assumes computer's RTC is set correctly.. 
 ...
 // }
  ...
  minute = 0x16;    // e.g., 3.29pm
  hour   = 0x16;
  wkDay  = 0x01;    // sunday = 1, ... saturday = 7
  day    = 0x07;
  month  = 0x04;    // april 
  year   = 0x19;    // 2019
  sqen   = 0x00;        // disable SQW output
